...
export const featuredProjects = [
  {
    ...
    developerNotes: "I like FormMate because boring forms are one of the clearest places AI should save time without taking away control. The hard part is making it helpful without encouraging spammy bulk submission, so the product has to stay review-first and honest about what it can safely automate.",
    notes: "I like FormMate because boring forms are one of the clearest places AI should save time without taking away control. The hard part is making it helpful without encouraging spammy bulk submission, so the product has to stay review-first and honest about what it can safely automate.",
  ...
  },
  {
    ...
    developerNotes: "PasteVault is one of those utilities I would actually keep open because it solves the tiny daily friction of sending text to yourself. The product challenge is trust: if it becomes a real cross-device vault, privacy, sync, and search quality need to feel dependable from day one.",
    notes: "PasteVault is one of those utilities I would actually keep open because it solves the tiny daily friction of sending text to yourself. The product challenge is trust: if it becomes a real cross-device vault, privacy, sync, and search quality need to feel dependable from day one.",
  ...
  },
  {
    ...
    developerNotes: "This is personal infrastructure more than a single app, and that is why I keep coming back to it. The best skills make future work faster, but the maintenance risk is real: they need to stay small, current, and specific instead of turning into vague prompt folders.",
    notes: "This is personal infrastructure more than a single app, and that is why I keep coming back to it. The best skills make future work faster, but the maintenance risk is real: they need to stay small, current, and specific instead of turning into vague prompt folders.",
  ...
  },
  {
    ...
    developerNotes: "Restore AI has obvious emotional value because old or damaged images matter to people. The part I cannot hand-wave is quality and cost: restoration has to be good enough to trust, private enough for personal photos, and efficient enough to run as a real product.",
    notes: "Restore AI has obvious emotional value because old or damaged images matter to people. The part I cannot hand-wave is quality and cost: restoration has to be good enough to trust, private enough for personal photos, and efficient enough to run as a real product.",
    visual: { label: "Restore", kicker: "Image repair", accent: "#FCA5A5", secondary: "#38BDF8" },
  },
];

export const majorProjects = [
  { name: "Bountic", repoName: "bountic", slug: "bountic", subtitle: "Autonomous USDC bounties", description: "Zero-friction, autonomous USDC bounties for the agentic open-source economy.", url: repo("bountic"), liveUrl: "https://bountic.vercel.app", tech: ["crypto", "agents", "open source"], status: "Exploratory product build", notes: "Strong concept and market framing around agentic work, incentives, and open-source contribution.", visual: { label: "Bountic", kicker: "Bounty economy", accent: "#8EF6E4", secondary: "#F6C177" } },
  ...
  { name: "SignalOps", repoName: "signalops", slug: "signalops", subtitle: "Security triage cockpit", description: "An agentic security and operations triage cockpit.", url: repo("signalops"), liveUrl: "https://signalops-orpin.vercel.app", tech: ["typescript", "security", "ops"], status: "Product cockpit concept", notes: "Fits the premium dashboard direction and agent-ops theme.", visual: { label: "SignalOps", kicker: "Security ops", accent: "#F87171", secondary: "#60A5FA" } },
